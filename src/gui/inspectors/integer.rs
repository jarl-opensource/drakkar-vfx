...
/// Integer inspector field for models editor.
...
impl Inspector for IntegerInspector
{
    type Value = i32;

    /// Create a new integer inspector with initial value.
    ///
...
impl Render for IntegerInspector
{
